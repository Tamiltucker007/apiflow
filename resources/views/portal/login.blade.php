    ...
    <div class="min-h-screen grid lg:grid-cols-2">
        <div class="flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-20">
            <div class="w-full max-w-sm mx-auto">
                ...
                <p class="text-sm text-gray-500 mt-1 mb-8">Sign in to view your usage and invoices.</p>
            ...
            <div class="relative z-10 w-full max-w-md">
                <div class="rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl p-6">
                    <div class="flex items-center justify-between mb-5">
                        <span class="text-xs font-medium text-white/70 uppercase tracking-wider">Your Usage</span>
                        <span class="text-xs px-2 py-0.5 rounded-full bg-emerald-400/20 text-emerald-300">Live</span>
                    </div>

                    <div class="mb-5">
                        <div class="flex items-baseline justify-between mb-1.5">
                            <span class="text-white text-2xl font-semibold">32,400</span>
                            <span class="text-white/60 text-xs">/ 50,000 units</span>
                        </div>
                        <div class="h-1.5 rounded-full bg-white/15 overflow-hidden">
                            <div class="h-full w-[65%] rounded-full bg-gradient-to-r from-emerald-400 to-teal-300"></div>
                        </div>
                    </div>

                    <div class="flex items-end gap-1.5 h-16 mb-5">
                        @foreach ([30, 55, 40, 70, 50, 80, 60] as $bar)
                    ...
                    <div class="flex items-center justify-between text-sm border-t border-white/10 pt-4">
                        <span class="text-white/70">Current plan</span>
                        <span class="text-white font-medium">Growth</span>
                    </div>
                </div>

                <div class="mt-10 text-center">
                    <h2 class="text-white text-2xl font-semibold mb-3">Your usage, always in view.</h2>
                    <p class="text-indigo-100/90 text-sm leading-relaxed mb-6">
                        See exactly what you've used this cycle, download past invoices, and never get surprised by an overage charge.
                    </p>

                    <ul class="inline-flex flex-col gap-2 text-left">
                        @foreach (['Real-time usage tracking', 'Instant invoice downloads', 'Secure, tenant-isolated access'] as $feature)
